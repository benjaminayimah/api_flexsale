...
<body>
<table style="width: 100%; background-color: #F2F2F7">
    <tbody>
        <tr>
            <td style="padding: 80px 0;">
                <table style="width: 50%; max-width: 550px; min-width: 220px; margin: 0 auto">
                    <tbody>
                        <tr>
                                ...
                                <div class="body-card" style="background-color: #fff; padding: 30px; border-radius: 16px; border: 1px solid #F0F0F0">
                                    <p style="text-align: center">
                                        <a href="https://www.flexsale.store" target="_blank">
                                            <img aria-hidden="true" src="http://localhost:8000/storage/flexsale-email-logo.png" height="40" alt="flexsale">
                                        </a>
                                    </p>
                                    <div style="color: rgb(34, 34, 34);">
                                        ...
                                        <p>
                                        Your have requested a password reset. Please proceed by clicking on the link below. Or copy and paste the link into your browser if you're having trouble clicking.
                                        </p>
                                        <p>
